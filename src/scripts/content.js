...
function executeScript(title) {
  const provider_url = {
    ...
    opensubtitles:
      "https://www.opensubtitles.org/en/search2/sublanguageid-cze/moviename-",
  };
  let openURL = provider_url.titulky + title.replace(/\s+/g, "+");
  ...
  document
    .querySelector(cssSelectors.titleName)
  ...
  document
    .querySelector(cssSelectors.titleName)
    .insertAdjacentElement("afterend", a2);
}
